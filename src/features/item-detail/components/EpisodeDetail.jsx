    ...
    <DetailWrapper>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-wrap gap-6 justify-center">
            <div className="text-center">
              ...
              <span className="mt-1 block text-xl font-bold bg-gradient-to-r from-purple-500 to-indigo-500 text-transparent bg-clip-text">📖 에피소드</span>
            </div>
            <div className="text-center">
      ...
      <main>
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4 pb-2 border-b-2 border-white/30">에피소드 내용</h2>
